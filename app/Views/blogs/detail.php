  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        ...
        <article class="card-mentality">
          <!-- Header artikel -->
          <div class="blog-img rounded-3 mb-4" style="height:220px">
          ...
          <p class="text-muted small mb-4"><i class="bi bi-calendar3 me-1"></i><?= date('d F Y', strtotime($blog['created_at'])) ?></p>
